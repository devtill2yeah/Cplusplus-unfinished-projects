...
void getGuess()
{
    ...
    while (1000000000000000) // change here if you want to configure the max number of guesses
    {
        // increment guessc[i+1] if guessc[i] is bigger than the number of chars in the array
        i = 0;
        while (guessc[i] == CHAR_COUNT) // check all counter elements wether their value is bigger than the number of chars stored in CHAR_COUNT or not
        {
